      ...
      <div className="flex items-center justify-center p-4" style={{ minHeight: 'calc(100vh - 120px)' }}>
        ...
        <div className="text-center space-y-8">
          ...
          <div className="text-center text-gray-400 text-sm">
            <p>🎮 <strong>3 Complete Games</strong> • 🥊 <strong>6 Boxing Legends</strong> • 🚁 <strong>Helicopter Combat</strong> • 🎨 <strong>Professional Art Tools</strong></p>
            <p className="mt-2">Built with Next.js, TypeScript, Canvas API, and Web Audio API</p>
            <p className="mt-1 text-purple-400">🎵 <strong>Custom Music Player</strong> - Upload your own songs!</p>
          </div>
        </div>
      </Card>
      </div>

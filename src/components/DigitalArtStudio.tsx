...
export default function DigitalArtStudio({ onBack }: DigitalArtStudioProps) {
  ...
  const downloadArtwork = (format: 'png' | 'jpg') => {
    const canvas = canvasRef.current;
    if (canvas) {
      // Create a new canvas with copyright watermark
      ...
      // Draw the original artwork
      exportCtx.drawImage(canvas, 0, 0);
      
      // Add copyright watermark to downloaded image
      exportCtx.save();
      exportCtx.globalAlpha = 0.7;
      exportCtx.fillStyle = '#000000';
      exportCtx.font = 'bold 16px Arial';
      exportCtx.textAlign = 'right';
      exportCtx.fillText('© 2025 Justin Devon Mitchell', canvas.width - 10, canvas.height - 10);
      exportCtx.fillStyle = '#666666';
      exportCtx.font = '12px Arial';
      exportCtx.fillText('justinmitchell6789@gmail.com', canvas.width - 10, canvas.height - 30);
      exportCtx.restore();
      
      const link = document.createElement('a');
      link.download = `${artworkTitle}_©2025_JustinDevonMitchell.${format}`;
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-emerald-800 to-green-900 p-4">
      <div className="max-w-7xl mx-auto space-y-4">
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          {/* Canvas Area */}
          <Card className="col-span-6 p-4 bg-gray-900/95 border-green-700 relative">
